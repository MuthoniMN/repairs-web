...
import { ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, FileSpreadsheet, Plus, UsersRound } from "lucide-react";
...
export default function ContractorsList() {
    ...
    }, [contractors, currentPage, itemsPerPage]);
                ...
                contractors.length > 0 ? (
                    <div>
                        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
                            {
                                paginatedContractors.map(contr => (
                                    <ContractorCard key={contr.id} contractor={contr} />
                                ))
                            }
                        </div>
                        {/* Pagination Controls */}
